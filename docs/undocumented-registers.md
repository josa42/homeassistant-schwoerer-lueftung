...
Exposed as `temperature_t9`, off by default.

It is the room 1 temperature. Over a week of five-minute means, 1984 samples,
208 tracks the room 1 actual temperature at register 360 with a mean absolute
difference of 0.04 K, while the other five rooms sit 0.65 to 1.86 K away. It
follows room 1 through step changes too: both dropped 1.3 K within the same
minute on 2026-09-11. Why the same value is exposed twice is unknown; a
reference-room copy the controller works from is the obvious guess and is not
evidence.
